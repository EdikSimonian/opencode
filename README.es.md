...
brew install ediksimonian/tap/opencode # macOS y Linux (recomendado, siempre al día)
...
nix run nixpkgs#opencode           # o github:ediksimonian/opencode para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/ediksimonian/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
