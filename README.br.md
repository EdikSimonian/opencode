...
brew install ediksimonian/tap/opencode # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#opencode           # ou github:ediksimonian/opencode para a branch dev mais recente
```
...
O OpenCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/ediksimonian/opencode/releases) ou em [opencode.ai/download](https://opencode.ai/download).
