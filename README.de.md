...
brew install ediksimonian/tap/opencode # macOS und Linux (empfohlen, immer aktuell)
...
nix run nixpkgs#opencode           # oder github:ediksimonian/opencode für den neuesten dev-Branch
```
...
OpenCode ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/ediksimonian/opencode/releases) oder [opencode.ai/download](https://opencode.ai/download) herunter.
