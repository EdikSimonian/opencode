...
brew install ediksimonian/tap/opencode # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#opencode           # или github:ediksimonian/opencode для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/ediksimonian/opencode/releases) или с [opencode.ai/download](https://opencode.ai/download).
