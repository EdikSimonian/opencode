...
<p align="center">
  ...
  <a href="https://github.com/ediksimonian/opencode/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/ediksimonian/opencode/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
brew install ediksimonian/tap/opencode # macOS e Linux (consigliato, sempre aggiornato)
...
nix run nixpkgs#opencode           # oppure github:ediksimonian/opencode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/ediksimonian/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
