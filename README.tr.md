...
brew install ediksimonian/tap/opencode # macOS ve Linux (önerilir, her zaman güncel)
...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:ediksimonian/opencode
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/ediksimonian/opencode/releases) veya [opencode.ai/download](https://opencode.ai/download) adresinden indirebilirsiniz.
