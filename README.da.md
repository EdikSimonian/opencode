...
brew install ediksimonian/tap/opencode # macOS og Linux (anbefalet, altid up to date)
...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/ediksimonian/opencode/releases) eller [opencode.ai/download](https://opencode.ai/download).
