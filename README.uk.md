...
brew install ediksimonian/tap/opencode # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#opencode           # або github:ediksimonian/opencode для найновішої dev-гілки
```
...
OpenCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/ediksimonian/opencode/releases) або [opencode.ai/download](https://opencode.ai/download).
