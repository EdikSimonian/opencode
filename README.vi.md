...
brew install ediksimonian/tap/opencode # macOS và Linux (khuyên dùng, luôn cập nhật)
...
nix run nixpkgs#opencode           # hoặc github:ediksimonian/opencode cho nhánh dev mới nhất
```
...
OpenCode cũng có sẵn dưới dạng ứng dụng desktop. Tải trực tiếp từ [trang releases](https://github.com/ediksimonian/opencode/releases) hoặc [opencode.ai/download](https://opencode.ai/download).
