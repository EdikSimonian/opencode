...
brew install ediksimonian/tap/opencode # macOS og Linux (anbefalt, alltid oppdatert)
...
nix run nixpkgs#opencode           # eller github:ediksimonian/opencode for nyeste dev-branch
```
...
OpenCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/ediksimonian/opencode/releases) eller [opencode.ai/download](https://opencode.ai/download).
