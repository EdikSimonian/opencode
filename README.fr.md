...
brew install ediksimonian/tap/opencode # macOS et Linux (recommandé, toujours à jour)
...
nix run nixpkgs#opencode           # ou github:ediksimonian/opencode pour la branche dev la plus récente
```
...
OpenCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/ediksimonian/opencode/releases) ou [opencode.ai/download](https://opencode.ai/download).
